...
class OnlineCheckoutController extends Controller
{
    ...
    public function onlineCheckout() {
        ...
        $vnp_Returnurl =  route('thank.store');  // "http://127.0.0.1:8000/admin/phieuphat/";
        $vnp_TmnCode = "YSX38442";//Mã website tại VNPAY
        $vnp_HashSecret = "UFUPVCJHQOHAXNCZZNHKJPKNYGDJZGAH"; //Chuỗi bí mật
        // 
//        $vnp_TxnRef =  $_POST['order_id']; // $vnp_TxnRef =  rand(00, 9999) $_POST['order_id'] Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
