...
$(".slider-for").slick({
  ...
  fade: true, 
  asNavFor: ".slider-nav",
  nextArrow: '<div class="custom-arrow next" style="color: white;"><span>Next</span><i class="fas fa-chevron-right ms-3"></i></div>',
  prevArrow: '<div class="custom-arrow prev" style="color: white;"><i class="fas fa-chevron-left me-3"></i><span>Prev</span></div>',
});
$(".slider-nav").slick({
  slidesToShow: 3,
  slidesToScroll: 1,
